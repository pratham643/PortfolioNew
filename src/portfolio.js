  ...
  schools: [
    {
      ...
      logo: require("./assets/images/kiitlogo.png"),
    ...
    {
      schoolName: "NESK",
      logo: require("./assets/images/nesklogo.png"),
  ...
  experience: [
    {
      ...
      companylogo: require("./assets/images/RSLlogo.png"),
   ...
   
    {
      ...
      companylogo: require("./assets/images/letsgrowlogo.png"),
  ...
  achievementsCards: [
    {
      ...
      image: require("./assets/images/SIH-Logo.png"),
      imageAlt: "SIH Logo",
      footerLink: [
        {
          name: "Certification",
